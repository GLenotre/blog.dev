...
@section('content')
      	...
      	<div class="row well">
		    ...
		    <div class="col-sm-4">
      			<div class = "text-center"><a href="http://s.codepen.io/glenotre/debug/oxOqEV" target="_blank">
      				<img class="img-responsive projects thumbnail" src="/img/rsz_js_simple_simon.jpg"></a>
      				<div class="caption">
        			<h3>JS Simple Simon</h3>
        			<p>See how long you last in this memory game.</p>
      				</div>
      			</div>
	    	</div>
    		<div class="col-sm-4">
      			<div class = "text-center"><a href="http://s.codepen.io/glenotre/debug/BoqwKY" target="_blank">
      				<img class="img-responsive projects thumbnail" src="/img/rsz_Whackarat_Game.jpg"></a>
      				<div class="caption">
        			<h3>JS Whackarat Game</h3>
        			<p>Play a version of whackamole against rats.</p>
      				</div>
      			</div>
	    	</div>
		</div>
